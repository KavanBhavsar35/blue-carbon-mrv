...
def initialize_blockchain_connection():
    ...
    try:
        ...
        # Load contract ABI
        abi_file_path = "../demo/artifacts/contracts/BlueCarbonCredits.sol/BlueCarbonCredits.json"
...
@app.route("/generate-credits", methods=["POST"])
...
@app.route("/check-credits/<address>", methods=["GET"])
...
if __name__ == "__main__":
    print("🌱 BlueCarbonCredits Flask API Server")
    print(f"📝 Contract Address: {CONTRACT_ADDRESS}")
    print(f"🔗 Hardhat Node: {NODE_URL}")
    ...
    if initialize_blockchain_connection():
        ...
        print("❌ Failed to initialize blockchain connection")
        print("\n🔧 Troubleshooting steps:")
        print("1. Make sure Hardhat node is running: npx hardhat node")
        print("2. Verify contract is deployed at the correct address")
        print("3. Check if the ABI file exists at the specified path")
        print("4. Ensure the contract address is correct")